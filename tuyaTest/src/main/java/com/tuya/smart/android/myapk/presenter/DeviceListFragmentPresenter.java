...
import com.tuya.smart.android.myapk.activity.AddDeviceTipActivity;
import com.tuya.smart.android.myapk.activity.BrowserActivity;
import com.tuya.smart.android.myapk.activity.CommonDeviceDebugActivity;
import com.tuya.smart.android.myapk.activity.SharedActivity;
import com.tuya.smart.android.myapk.activity.SwitchActivity;
import com.tuya.smart.android.myapk.config.CommonConfig;
import com.tuya.smart.android.myapk.event.DeviceListUpdateModel;
import com.tuya.smart.android.myapk.event.DeviceUpdateEvent;
import com.tuya.smart.android.myapk.fragment.DeviceListFragment;
import com.tuya.smart.android.myapk.test.utils.DialogUtil;
...
import com.tuya.smart.android.myapk.view.IDeviceListFragmentView;
...
//        mActivity.startActivity(intent);
    ...
    public void addDemoDevice() {
        Log.d("TAG", "addDemoDevice: 添加设备 页面点击");
        ProgressUtil.showLoading(mActivity, null);
        TuyaSmartRequest.getInstance().requestWithApiName("s.m.dev.sdk.myapk.list", "1.0", null, new IRequestCallback() {
            @Override
